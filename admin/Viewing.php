                     ...
                     <form action="" method="post">
                         ...
                         <table class="form">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <input type="email" value="<?php echo $row['email']; ?>" class="medium" style="width: 250px;"/>
                                 </td>
                             </tr>
                             <tr>
                                 <td>
                                 ...
                                 <td>
                                     <input type="text" value="<?php echo $row['address']; ?>" class="medium" style="width: 250px;"/>
                                 </td>
                             </tr>
                             <tr>
                                 <td>
                                 ...
                                 <td>
                                     <input type="text" value="<?php echo $row['date'];?>" class="medium" style="width: 250px;"/>
                                 </td>
                             </tr>
                             <tr>
                                 <td>
                             ...
                             <tr>
                                 <td></td>
                                 <td><button type="submit" ><a href="Inbox.php">OK</a></button></td>
                             </tr>
